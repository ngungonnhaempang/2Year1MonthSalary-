...
module.exports = function (app, request, config, express) {
    ...
    app.get('/ehs/ModificationAndRisk/PID', GateRoute.Get_ModificationAndRiskPID);
    app.get('/ehs/EvaluationAndClosing/PID', GateRoute.Get_EvaluationAndClosingPID);
    app.get('/ehs/EastGateInOut/PID', GateRoute.Get_EastGateInOutPID);

    app.get('/ehs/DenounceContractorProcess/PID', GateRoute.Get_DenounceContractorPID);
    app.get('/ehs/ContractorDiscipline/PID', GateRoute.Get_ContractorDisciplinePID);
