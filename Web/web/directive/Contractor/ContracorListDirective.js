...
define(['app', 'angular'], function (app, angular) {
    app.directive('contractorList', ['$resource', '$http', '$filter', 'Notifications', 'ConQuaService', '$routeParams', 'Auth', 'EngineApi', 'GateGuest', '$timeout', '$translate', '$location', 'Forms','$upload',
        function ($resource, $http, $filter, Notifications, ConQuaService, $routeParams, Auth, EngineApi, GateGuest, $timeout, $translate, $location, Forms,$upload) {
            return {
                ...
                templateUrl: './forms/ConQua/createContractor.html'
            }
        }]);
});