        ...
        function ($resource, $q, Auth, $location, $translate, EngineApi, Forms) {
            function LIMSService() {
                ...
                this.Entrusted = $resource(sourceAPI, {}, {
                    ...
                    Get_BarcodeInStock:{method:'GET',params:{operation:'Get_BarcodeInStock'}},
                    GET_EvaluateStapleGrade:{method:'GET',params:{operation:'GET_EvaluateStapleGrade'}},
                    Save_StaplePickForGrade:{method:'POST',params:{operation:'Save_StaplePickForGrade'}},
                    StapleFiber_ReportByBatch:{method:'GET',params:{operation:'StapleFiber_ReportByBatch'}},
                    GET_PrecValueBySampleName:{method:'GET',params:{operation:'GET_PrecValueBySampleName'}}
                ...
                this.ISOQualify = $resource('/LIMS/ISO/:operation', {}, {
                    ...
                    UpdateSubmittedVoucher: { method: 'POST', params: { operation: 'UpdateSubmittedVoucher' } }, //update status with detail added and notification
                ...
                this.gradeVersion = $resource('LIMS/Grades/:operation', {}, {
                    ...
                    UpdateVersion: { method: 'POST', params: { operation: 'Update' } },
                    ...
                    HistoryforGrade_Report: { method: 'GET', params: { operation: 'GD_HistoryforGrade_Report' }, isArray: true },
                    ...
                    Special_ModifyGradeVersion :{method:'POST', params:{operation:'SaveSpecial_ModifyVersion'}},
                    UpdateGradeStatus: {method: 'PUT', params: {operation: 'UpdateGradeStatus'}},
