    ...
    app.service('LIMSBasic', ['$resource', '$q', 'Auth', '$location', '$translate', function($resource, $q, Auth, $location, $translate) {
        function LIMSBasic() {
            ...
            this.QCBasic = $resource('/LIMS/Basic/:operation', {}, {
                ...
                getSamplesBySampleName: { method: 'GET', params: { operation: 'GetSamplesBySampleName' }, isArray: true },
                ...
                getVendor:{method:'GET',params:{operation:'GetVendor'},isArray:true}
        ...
        LIMSBasic.prototype.GetSamplesBySampleName = function(query, callback) {
            this.QCBasic.getSamplesBySampleName(query).$promise.then(function(datas) {
                callback(datas);
            }, function(ex) {
                console.log(ex);
                callback(null, ex);
        ...
        LIMSBasic.prototype.getVendor = function(query, callback) {
            this.QCBasic.getVendor(query).$promise.then(function(datas) {
                callback(datas);
            }, function(ex) {
                console.log(ex);
                callback(null, ex);
