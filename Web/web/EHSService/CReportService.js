define(['app', 'angular'], function (app, angular) {
    app.service('CReportService', [
        ...
        function ($resource, $q, Auth, $location, $translate, EngineApi, Forms) {
            function CReportService() {
                ...
                this.GetInfoBasic = $resource('/Waste/CReportController/:operation', {}, {
                    ...
                    UpdateImprovementStatus:{
                        method:'PUT',
                        params:{
                            operation:'UpdateImprovementStatus'
                        }
                    }
            ...
            CReportService.prototype.G_ActionEvaluate = function(query,callback){
                this.GetInfoBasic.G_ActionEvaluate(query).$promise.then(function(data){
                    if(data){
                        callback(data)
                    }
