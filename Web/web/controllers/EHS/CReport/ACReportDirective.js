define(['app'], function (app) {
    app.directive('createAcReport', ['CReportService', 'InfolistService', 'Auth', '$timeout', 'Notifications', '$translate', '$upload','$filter',
        function (CReportService, InfolistService, Auth, $timeout, Notifications, $translate, $upload,$filter ) {
            return {
                restrict: 'E',
                controller: function ($scope) {
                    ...
                    function saveInitDataAC() {
                        ...
                        note.RpIC_Group ='';
                        note.RpIC_Description='';
                        note.RpIC_DirectReason='';
                        note.RpIC_IndirectReason='';
                        note.RpIC_BasicReason='';
                        note.RpIC_Damage='';
                        note.RpIC_Process='';
                        note.RpIC_Evaluate='';
                        note.RpIC_IncidentType='';
                        note.RpIC_Affect='';
                        note.RpIC_AffectRange='';
                        note.RpIC_TimeNotif=$filter('date')(new Date(), "yyyy-MM-dd");
                        note.RpIC_NotifPerson='';
                        note.RpIC_ReceivePerson='';
                        note.RpIC_Damaged_Human='';
                        note.RpIC_Damaged_Asset='';
                        note.RpIC_Damaged_Envr='';
                        ...
                        note.Estimate_DateComplete = $scope.recordAC.ac_datecomp;
