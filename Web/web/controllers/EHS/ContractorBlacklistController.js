...
define(['myapp', 'angular'], function (myapp, angular) {
    myapp.controller("ContractorBlacklistController", ['$scope', 'ConQuaService', '$translate', 'EngineApi', 'Auth','$filter','Notifications',
        function ($scope, ConQuaService, $translate, EngineApi, Auth,$filter,Notifications) {
            ...
            var columns = [
                ...
                },
                {
                    ...
                    displayName: $translate.instant('ConQua_ContractorName'),
                    minWidth: 150,
                    cellTooltip: true
                },
                {
                ...
                },
                {
                    field: 'Phone',
                    minWidth: 100,
                    displayName: $translate.instant('ConQua_Phone'),
                    cellTooltip: true
                },
                {
                    field: 'StartDate',
                    minWidth: 70,
                    displayName: $translate.instant('ConQua_CQValidFrom'),
                    cellTooltip: true
                },
                {
                    field: 'EndDate',
            ...
            var gridMenu = [{
                    ...
                    action: function () {
                        ...
                        if (resultRows.length == 1 && resultRows[0].State != 'X') {
                           ...
                           let result = blacklistContractors.filter(x=>x.BlackID == id)[0]; 
                           $scope.black = result;
                            $('#myModal').modal('show');
            ...
            var getParams = () => {
                ...
                params.BusinessID = $scope.black.ContractorID || ''
            ...
            $scope.Search = function () {
                ...
                ConQuaService.SearchBlacklistVoucher(params, function (res) {
                    $scope.gridOptions.data = blacklistContractors = res;
