        ...
        function ($filter, Notifications, Auth, EngineApi, CompanyService, $timeout, $translate, $q, $scope) {
            ...
            function loadCompanyDetail(id) {
                ...
                CompanyService.FindByID({
                    ...
                    $scope.recod.basephone = data.BasePhone;
                    $scope.recod.baseaddress = data.BaseAddress;
            ...
            var col = [
                ...
                ,
                {
                    field: 'BasePhone',
                    minWidth: 70,
                    displayName: $translate.instant('BasePhone'),
                    cellTooltip: true
                },
                {
                    field: 'BaseAddress',
                    minWidth: 100,
                    displayName: $translate.instant('BaseAddress'),
                    cellTooltip: true
                },
                {
                    field: 'Status',
