    ...
    app.service("GateGuest",[ '$resource','$q','Auth','$location','$translate', function($resource,$q,Auth,$location,$translate) {
        function GateGuest(){
            ...
            this.getGateCheckers= $resource('/ehs/gate/Checker/:operation', {}, {
                ...
                OS_CheckerOverGrade:{method:'GET',params:{operation:'OS_CheckerOverGrade'},isArray:true}
            });
        ...
        GateGuest.prototype.GetCheckUpdateList=function(){
            return  [{"name": $translate.instant('agree'), "value": "YES"}];
        };
