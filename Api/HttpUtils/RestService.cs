...
namespace HttpUtils
{
    public class RestService
    {
        ...
        public string SendTaskComment(string url, string taskid, string messageName, string businessKey, string messageComment, string JWUser, string ExceptionType, string Initiator)
        {
            try
            {
                //例如：ExceptionType="成品短驳超重"
                ...
                fdExceptionType.value = ExceptionType;
                fdExceptionType.type = "String";
                FormDatas fdInitiator = new FormDatas();
                fdInitiator.value = Initiator;
                fdInitiator.type = "String";

                processVariables.Add("ReasonTitle", fdReasonTitle);
                processVariables.Add("JWUser", fdJWUser);
                processVariables.Add("ExceptionType", fdExceptionType);
                processVariables.Add("initiator", fdInitiator);
        ...
        public bool GetShippingOrder(string url, string Trantype, string Outno, out string ErrMsg, out ShippingOrderERPOutput orderinfo)
        {
            try
            {
